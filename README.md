...
| `ADMINER_VERSION` | `5.4.3` | Adminer version |
...
- `snowdreamtech/adminer:5.4.3-debian`
- `snowdreamtech/adminer:5.4.3-alpine`
- `snowdreamtech/adminer:5.4.3-rocky`

This format allows:

- **Full version pinning**: `5.4.3-debian` (exact version)
