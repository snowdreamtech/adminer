...
| `ADMINER_VERSION` | `5.5.1` | Adminer version |
...
- `snowdreamtech/adminer:5.5.1-debian`
- `snowdreamtech/adminer:5.5.1-alpine`
- `snowdreamtech/adminer:5.5.1-rocky`

This format allows:

- **Full version pinning**: `5.5.1-debian` (exact version)
