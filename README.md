...
| `ADMINER_VERSION` | `6.0.1` | Adminer version |
...
- `snowdreamtech/adminer:6.0.1-debian`
- `snowdreamtech/adminer:6.0.1-alpine`
- `snowdreamtech/adminer:6.0.1-rocky`

This format allows:

- **Full version pinning**: `6.0.1-debian` (exact version)
