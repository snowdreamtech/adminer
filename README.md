...
| `ADMINER_VERSION` | `6.0.0` | Adminer version |
...
- `snowdreamtech/adminer:6.0.0-debian`
- `snowdreamtech/adminer:6.0.0-alpine`
- `snowdreamtech/adminer:6.0.0-rocky`

This format allows:

- **Full version pinning**: `6.0.0-debian` (exact version)
