...
| `ADMINER_VERSION` | `6.0.2` | Adminer version |
...
- `snowdreamtech/adminer:6.0.2-debian`
- `snowdreamtech/adminer:6.0.2-alpine`
- `snowdreamtech/adminer:6.0.2-rocky`

This format allows:

- **Full version pinning**: `6.0.2-debian` (exact version)
